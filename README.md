# Resources from Geek97 meetup done on 14th July 2018
...
# create a docker image on local machine or download one from Docker Hub for inference
# for the demo, I will pull nginx which I will push into private repository

# skip this step if you have your custom image created.
docker pull nginx

# set the image name below of yoiur custom image
$image = "nginx"

# login into private container repository using the credentials
docker login -u $acrName -p $acrPassword $loginServer

# declare image tag for repository
...
#### Designing Distribued Systems, free ebook
...
#### Azure Container Instance Quotas
